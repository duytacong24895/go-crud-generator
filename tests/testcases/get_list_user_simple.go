...
func NewTestCaseGetListUserWithFilter(db *gorm.DB, serverUrl string) pkg.ITestCase {
	return &getListUserWithFilter{
		db:        db,
		serverUrl: serverUrl,
...
type getListUserWithFilter struct {
	db        *gorm.DB
	serverUrl string
	Expected  any
	Actual    any
...
func (t *getListUserWithFilter) Name() string {
	return "Normal Case: get list Employee with simple filter"
}

func (t *getListUserWithFilter) Preparing() error {
...
func (t *getListUserWithFilter) Cleaning() error {
	return t.db.Migrator().DropTable(&models.Employee{})
}

func (t *getListUserWithFilter) Do() error {
	done := make(chan bool)
	go func() {
		for {
			select {
...
func (t *getListUserWithFilter) GetExpected() (any, error) {
	...
	return []models.Employee{
		{
			...
			Email:  dummiesdata.Employee_NormalCaseCreateEmployee3["Email"].(string),
			Dob:    dob,
			Age:    int64(dummiesdata.Employee_NormalCaseCreateEmployee3["Age"].(int)),
			Phone:  dummiesdata.Employee_NormalCaseCreateEmployee3["Phone"].(string),
			Mature: dummiesdata.Employee_NormalCaseCreateEmployee3["Mature"].(bool),
		},
	}, nil
...
func (t *getListUserWithFilter) GetActual() (any, error) {
...
func (t *getListUserWithFilter) CheckResult() (bool, error) {
...
func (t *getListUserWithFilter) RunTest() (bool, error) {
